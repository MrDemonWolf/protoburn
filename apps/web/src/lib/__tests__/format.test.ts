...
describe("getFireLevel", () => {
  ...
  it("returns 1 flame for small cost", () => {
  ...
  it("returns 2 flames for cost >= 5", () => {
    ...
    expect(getFireLevel(19.99).flames).toBe(2);
  });

  it("returns 3 flames for cost >= 20", () => {
    expect(getFireLevel(20).flames).toBe(3);
    expect(getFireLevel(49.99).flames).toBe(3);
  });

  it("returns 4 flames for cost >= 50", () => {
    expect(getFireLevel(50).flames).toBe(4);
